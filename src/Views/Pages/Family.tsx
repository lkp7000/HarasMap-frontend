...
const Family = () => {
  ...
  useEffect(() => {
    ...
    if (response) {
      ...
      parsedResponse.filter((item: any) => {
        ...
        if (item?.questionGroupID?.questionGroupName === "Family") {
  ...
  const ageConditionalCheckerNew = (currentQuestion: any, selectedQuestion: any) => {
    ...
    if (currentQuestion?.shortKey === 'husband_affair') {

      selectedQuestion && Object?.entries(selectedQuestion)?.map(([questionId, questionItem]: any) => {

        if (questionItem?.shortKey == 'family_married') {
    ...
    } else if (currentQuestion?.shortKey === 'family_numberOfChildren') {
    ...
    } else if (currentQuestion?.shortKey === 'family_childrenInSchool') {
    ...
    } else if (currentQuestion?.shortKey === 'man_household') {
    ...
    } else if (currentQuestion?.shortKey === 'family_husbandEmployed') {
    ...
    } else if (currentQuestion?.shortKey === 'house_expence') {

      selectedQuestion && Object?.entries(selectedQuestion)?.map(([questionId, questionItem]: any) => {

        if (questionItem?.shortKey == 'live_man') {
    ...
    } else if (currentQuestion?.shortKey === 'family_manviolent') {
      selectedQuestion && Object?.entries(selectedQuestion)?.map(([questionId, questionItem]: any) => {
        if (questionItem?.shortKey == 'live_man') {
          if (questionItem?.optionText == 'No') {
            result = []
    ...
    } else if (currentQuestion?.shortKey === 'man_hit') {
      selectedQuestion && Object?.entries(selectedQuestion)?.map(([questionId, questionItem]: any) => {
        if (questionItem?.shortKey == 'live_man') {
          if (questionItem?.optionText == 'No') {
            result = []
    ...
    } else if (currentQuestion?.shortKey === 'habit_hit') {
    ...
    } else if (currentQuestion?.shortKey === 'family_ifNoWhy') {
